...
@utilotest.longrun
def test_miner_pdf():
    parsed_file = rawmaker.features.text.work(hoverpower.DOCU013_PDF)
    assert parsed_file
...
@pytest.mark.parametrize('source', (
    ...
    pytest.param(hoverpower.DOCU013_PDF, id='docu013'),
))
@utilotest.longrun
...
@pytest.mark.parametrize('source, remove_whitespace, validate', [
    ...
    pytest.param(hoverpower.BACHELOR063_PDF, True, None, id='bachelor_true'),
    pytest.param(
    ...
    pytest.param(hoverpower.MASTER072_PDF, True, None, id='master72_true'),
])
@utilotest.nightly
